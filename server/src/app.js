...
import PaymentsRouter from "./router/PaymentsRouter.js"; // importo PaymentsRouter desde la carpeta router/PaymentsRouter.js
...
app.use("/api/payments", PaymentsRouter); // ruta api/payments, que usa el PaymentsRouter de la carpeta router/PaymentsRouter.js
